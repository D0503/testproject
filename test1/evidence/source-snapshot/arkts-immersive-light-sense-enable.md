> 原文：https://developer.huawei.com/consumer/cn/doc/harmonyos-guides/arkts-immersive-light-sense-enable
...
各组件详细适配方法请参考[组件适配沉浸光感](./arkts-immersive-light-sense-component-adaptation.md)。
|
